...
var ACTION_DATA = [
	...
	{name: 'brush', 	title: 'Brush',			icon: ['all.png', -500+6, 3],	attributes: {type: 'Brush', type_values: ['Brush', 'BezierCurve', 'Chrome', 'Fur', 'Grouped', 'Shaded', 'Sketchy'], size: 5, blur: true  }, on_update: 'update_brush', },
